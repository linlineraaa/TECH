...
public class ProgramController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		YonghuEntity user = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("account", username));
    ...
    public R register(@RequestBody YonghuEntity yonghu){
    	...
    	YonghuEntity user = yonghuService.selectOne(new EntityWrapper<YonghuEntity>().eq("account", yonghu.getYonghuming()));
		if(user!=null) {
			return R.error("RegistrationUser Already Exists");
		}
    ...
    public R query(YonghuEntity yonghu){
		...
		return R.ok("SearchSuccess").put("data", yonghuView);
    }
