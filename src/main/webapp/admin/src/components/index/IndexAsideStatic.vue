        ...
        <el-menu mode="vertical" :unique-opened="true" class="el-menu-demo" style="height:100%;" background-color="#424A5D" text-color="#DAE2E8" active-text-color="#FEFEFE" default-active="0">
          ...
          <el-submenu :index="1+''" :style="menulistBorderBottom">
            <template slot="title">
              ...
              <span>User Centre</span>
            </template>
            <el-menu-item :index="1-1" @click="menuHandler('updatePassword')">Change password</el-menu-item>
            <el-menu-item :index="1-2" @click="menuHandler('center')" v-if="role=='Student'">User Information</el-menu-item>
          </el-submenu>
