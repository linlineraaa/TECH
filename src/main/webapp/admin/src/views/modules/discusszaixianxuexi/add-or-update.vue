  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="commentcontent" prop="content">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.content" label="commentcontent" prop="content">
                    <span>{{ruleForm.content}}</span>
                                ...
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="replycontent" prop="reply">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.reply" label="replycontent" prop="reply">
            ...
            ruleForm: {
                	        refid: '',
	                        	        ...
	                        	        reply: '',
                                                                    ...
                                                                    rules: {
                  refid: [
                            { required: true, message: 'relational table id cannot be empty', trigger: 'blur' },
                                    	                                                              ],
                  userid: [
