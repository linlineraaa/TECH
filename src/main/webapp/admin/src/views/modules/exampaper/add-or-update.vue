<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Quizname" prop="name">
          <el-input v-model="ruleForm.name"
              placeholder="Quizname" clearable  :readonly="ro.name"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Quizname" prop="name">
              <el-input v-model="ruleForm.name"
                placeholder="Quizname" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="Quiz Time(minute)" prop="time">
          <el-input v-model="ruleForm.time"
              placeholder="Quiz Time(minute)" clearable  :readonly="ro.time"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="Quiz Time(minute)" prop="time">
              <el-input v-model="ruleForm.time"
                placeholder="Quiz Time(minute)" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="QuizStatus" prop="status">
          <el-select v-model="ruleForm.status" placeholder="SelectQuizStatus">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="QuizStatus" prop="status">
              <el-input v-model="ruleForm.status?'Enable':'Disable'"
                placeholder="QuizStatus" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
  ...
  data() {
	...
	status : false,
            ...
            ruleForm: {
                    ...
                    rules: {
                  name: [
                            { required: true, message: 'Quizname cannot be empty', trigger: 'blur' },
                                    	                                                              ],
                  time: [
                            { required: true, message: 'Quiz Time(minute) cannot be empty', trigger: 'blur' },
                                        { validator: validateIntNumber, trigger: 'blur' },
                        	                                                              ],
                  status: [
                            { required: true, message: 'QuizStatus cannot be empty', trigger: 'blur' },
                                        { validator: validateIntNumber, trigger: 'blur' },
                        	                                                              ],
              }
    };
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.status = true;
            continue;
                                                                              ...
                                                                              this.statusOptions = "Disable ,Enable".split(',')
                            },
