  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" label="sex" prop="xingbie">
          ...
          <el-form-item class="input" label="email" prop="youxiang">
              <el-input v-model="ruleForm.youxiang"
                placeholder="email" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="student number" prop="shenfenzheng">
          <el-input v-model="ruleForm.shenfenzheng"
              placeholder="student number" clearable  :readonly="ro.shenfenzheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="student number" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng"
                placeholder="student number" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
