<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
        <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'" label="Posttitle" prop="title">
            <el-input v-model="ruleForm.title"
                      placeholder="Posttitle" clearable :readonly="ro.title"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="Posttitle" prop="title">
              <el-input v-model="ruleForm.title"
                        placeholder="Posttitle" readonly></el-input>
            </el-form-item>
          </div>
        </el-col>
        <el-col :span="12">
          <el-form-item class="select" v-if="type!='info'" label="Status" prop="isdone">
            <el-select v-model="ruleForm.isdone" placeholder="SelectStatus">
              <el-option
          ...
          <div v-else>
            <el-form-item class="input" label="Status" prop="isdone">
      ...
      <el-row>
        <el-col :span="24">
          <el-form-item v-if="type!='info'" label="Postcontent" prop="content">
            <editor
          ...
          <div v-else>
            <el-form-item v-if="ruleForm.content" label="Postcontent" prop="content">
  ...
  data() {
    ...
    return {
      ...
      ruleForm: {
        ...
        parentid: 0,
        userid: '',
        username: this.$storage.get("role"),
        isdone: '',
      },
      isdoneOptions: [],
      rules: {
        title: [],
        content: [
          {required: true, message: 'Postcontent cannot be empty', trigger: 'blur'},
        ],
        parentid: [],
        userid: [
