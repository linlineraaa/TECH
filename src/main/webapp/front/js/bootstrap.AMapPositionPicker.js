...
(function (factory) {
    ...
    function buildBootstrapModalHTML() {
        var toolsHtml = '<div class="btn-group">'
            + '<button id="idAMapPositionPickerLocation" type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-map-marker"></span>&nbsp;</button>'
            ...
            + '<button id="idAMapPositionPickerClear" type="button" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-remove"></span>&nbsp;</button>'
        ...
        var modalHtml = '<div class="modal fade" id="idAMapPositionPickerModal">'
            ...
            + '<div class="modal-header"><button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button><h4 class="modal-title">Select</h4><small id="idAMapPositionPickerAlert" style="color: red"></small></div>'
                    ...
                    AMap.service('AMap.PlaceSearch', function () {
                        ...
                        placeSearch.searchInBounds(searchKeyword, mapObj.getBounds(), function (status, result) {
                            ...
                            if (status == 'complete') {
                                ...
                                $searchPanel.append('<li class="list-group-item disabled"><small></small></li>');
                            }
                        });
                    });
                }
